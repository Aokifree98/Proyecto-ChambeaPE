...
import com.chambeape.entidades.DetalleAnuncio;
...
public class AnuncioOfertaTrabajo extends AppCompatActivity {
    ...
    public void crearAOT(View view) {
        crearAnuncioOfertar();
        Intent c = new Intent(this, MenuDesplegable.class);
        startActivity(c);
    }
    ...
    private void crearAnuncioOfertar() {
        ...
        DetalleAnuncio detalleAnuncio = new DetalleAnuncio(id,Habilidad1, Habilidad2, Habilidad3,
                "", descrAnuncio, "", ubiAnuncio, "","",
                "",idServicio,"","","",
                "","","");
