...
import com.example.chambeape.databinding.ActivityMenuPrincipalBinding;
...
public class MenuPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navInicio, R.id.navContactos, R.id.navHitorial, R.id.navAyuda, R.id.navConfiguracion, R.id.navCerrarSesion)
